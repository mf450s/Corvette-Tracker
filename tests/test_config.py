...
def test_standard_source_urls_use_requested_marketplace_urls():
    ...
    assert autoscout_query["cat"] == [
        "ma16380mo19141,ma16380mo19140,ma16380mo20782,ma16380mo75462,ma16380mo21061,ma16380mo74838,ma16380mo19142,ma16380mo19143"
    ]
...
""",
    ...
    assert (
        config["scoring"]["weights"]["non_convertible"]
        == default["scoring"]["weights"]["non_convertible"]
    )
